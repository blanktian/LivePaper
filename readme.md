...
This project is a fork of [Plash](https://github.com/sindresorhus/Plash) by [Sindre Sorhus](https://github.com/sindresorhus).

### Authors

- Original author: [Sindre Sorhus](https://github.com/sindresorhus)
- Current maintainer: [Blank Tian](https://github.com/blanktian)

## License

MIT © [Sindre Sorhus](https://sindresorhus.com), [Blank Tian](https://github.com/blanktian)
